...
public:
	//The "rule of 3" becomes the rule of 5
	//take the rule of 3 + add a MOVE CONSTRUCTOR and a 

	//Move constructor is moving the nodes from one LL to a new one so that the new one
	//keeps the nodes and the old LL has no nodes to destroy
